...
def upload_files(drive_service: Any,
                 admin_folder_id: str, room_folder_id: str,
                 core_email_list: list[str], send_email_flag: bool,
                 org_weekly_msg: str, core_weekly_msg: str,
                 core_monthly_msg: str, org_monthly_msg: str,
                 output_dir_admin: str, output_dir_reports: str,
                 sincere_download_dir: str) -> None:
    """Interactively upload admin and/or room reports to Google Drive.
    ...
    if upload_admin:
        ...
        upload_admin_report(drive_service, str_admin_report_to_upload,
                            folder_id=admin_folder_id, email_list=core_email_list,
